...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?php echo base_url; ?>Administracion/home">Punto Venta</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?php echo base_url; ?>Clientes" aria-controls="collapseLayouts">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseEntrada" aria-expanded="false" aria-controls="collapseEntrada">
                                <div class="sb-nav-link-icon"><i class="fas fa-shipping-fast text-primary"></i></div>
                                Entradas
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            ...
                            <div class="collapse" id="collapseSalida" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo base_url; ?>Compras/ventas">Nueva Ventas</a>
                                    <a class="nav-link" href="<?php echo base_url; ?>Compras/historial_ventas">Historial Venta</a>
                                </nav>
                            </div>

                            <a class="nav-link" href="<?php echo base_url; ?>Pacientes" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-users text-primary"></i></div>
                                Pacientes
                            </a>
